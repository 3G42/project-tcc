...
def add_simulation(n_clicks,sim_type:str,storage_data:Dict[str,List[Union[str, List[Union[str,float]]]]],previous_data):
...
@callback(
    Output('show-indicators','disabled'),
    Input('simulation-select','value')
)
def enable_indicator(value):
    if value != None:
        return False
    return True
